...
public class Mlp {
    ...
    public void momentumLayer3BackProp(int[][] inputLayer, int[][] label) {
        ...
        Utils.elementWiseMultiplication(diffPotentials.get(layers - 2), Utils.sigmoidDerivative(activations.get(layers-2)));
        
        Utils.matrixMultiplication(diffPotentials.get(layers - 2), Utils.transposeMat(inputLayer), diffWeights.get(layers - 2));
    ...
    public void verbosePrint() {
        for (int i = 0; i < layers; i++) {
            ...
            System.out.println("DiffWeights: " + Arrays.deepToString(diffWeights.get(i)));
            System.out.println("DiffBiases: " + Arrays.deepToString(diffBiases.get(i)));
            System.out.println("MomentumWeights: " + Arrays.deepToString(momentumWeights.get(i)));
            System.out.println("MomentumBiases: " + Arrays.deepToString(momentumBiases.get(i)));
        }
    }
